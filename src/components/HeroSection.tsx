    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-5xl mx-auto w-full" style={{ transformStyle: "preserve-3d" }}>
        ...
        <div ref={titleGroupRef} className="flex flex-col items-center transform-gpu z-10 -mt-20" style={{ transformStyle: "preserve-3d" }}>
          ...
          <div ref={badgeRef} className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full border border-black/10 bg-white/50 backdrop-blur-md mb-4 shadow-sm" style={{ opacity: 0, transform: "translateY(20px)" }}>
            <span className="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-[#7B2D3B] animate-pulse"></span>
            <span className="text-[10px] md:text-xs font-bold tracking-[0.15em] md:tracking-[0.2em] text-[#1A1A1A] uppercase">
              PROJETOS MECÂNICOS INDUSTRIAIS
            </span>
          </div>

          <h1 className="text-[1.85rem] sm:text-5xl md:text-7xl lg:text-[5rem] font-black leading-[1.05] tracking-tight mb-4 text-[#1A1A1A] perspective-1000" style={{ transformStyle: "preserve-3d" }}>
            <div className="block">
